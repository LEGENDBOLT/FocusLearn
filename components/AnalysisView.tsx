...
import { AnalysisResult, StudySession } from '../types';

// Helper component for rendering indicator bars
const IndicatorBar: React.FC<{ label: string; value: number; colorClass: string }> = ({ label, value, colorClass }) => (
    <div>
...
const AnalysisView: React.FC = () => {
    ...
    useEffect(() => {
        // Load sessions on component mount to check if analysis is possible
